 ...
 * the License.
 ******************************************************************************/
package it.cnr.iit.ucsinterface.routing;
...
public interface RoutingInterface {
     ...
     * Since everything is asynchronous the UCS sends the message and then leaves
     * a thread in charge of waiting for the response to arrive. The response will
     * be sent from the other UCS using this same api. <br>
     ...
     *          message we want to send, after having converted it in a json
     *          String into a container message.
     */
     ...
     */
    public boolean setRequestManangerInterface(
