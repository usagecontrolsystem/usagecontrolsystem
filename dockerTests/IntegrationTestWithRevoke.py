...
os.system("docker exec -it usagecontrolsystem_ucs_1 bash -c 'echo 40.0 > pips/temperature.txt'")
...
os.system("docker exec -it usagecontrolsystem_ucs_1 bash -c 'echo 20.0 > pips/temperature.txt'")
