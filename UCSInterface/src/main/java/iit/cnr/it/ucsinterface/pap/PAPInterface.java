 ...
 * the License.
 ******************************************************************************/
package iit.cnr.it.ucsinterface.pap;

import java.util.List;

/**
 * This is the interface to be used to ocmmunicate with the Policy
 ...
 * format, hence we may have to perform parsing and reparsing and this would not
 * make any sense.
 * </p>
 * 
 * @author antonio
