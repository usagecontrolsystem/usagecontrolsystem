...
final public class TryAccessMessageContent {
	...
	private transient static final Logger	MCLOGGER	= Logger
	    .getLogger(TryAccessMessageContent.class.getName());
	...
	public boolean setPepUri(String pepUri) {
		...
		if (pepUri == null || pepUri.isEmpty()) {
			MCLOGGER.log(Level.WARNING, "pep uri is not valid " + pepUri);
			return false;
		}
	...
	public boolean setPolicyId(String policyId) {
		// BEGIN parameter checking
		if (pepUri == null || pepUri.isEmpty()) {
			MCLOGGER.log(Level.WARNING, "policyId is not valid " + policyId);
			return false;
		}
		// END parameter checking
	...
	public boolean setRequest(String request) {
		...
		if (request == null || request.isEmpty()) {
			MCLOGGER.log(Level.WARNING, "Ivalid request " + request);
			return false;
		}
		// END parameter checking
		try {
