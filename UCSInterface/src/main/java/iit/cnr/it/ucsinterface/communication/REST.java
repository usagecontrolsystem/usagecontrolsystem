...
final public class REST {
	...
	// logger
	final private static Logger LOGGER = Logger.getLogger(REST.class.getName());
	...
	public static <T> T sendRequest(String uri, Object body, Class<T> clazz) {
		...
		if (response.getStatusCode() != HttpStatus.OK) {
			...
			LOGGER.log(Level.SEVERE,
			    "[REST] Some errors occurred, event dispatching terminates wrongly, HTTP status message is : "
